  ...
  useEffect(() => {
    ...
    class App {
      ...
      update(delta) {
        ...
        // Update uTime in distortion uniforms
        if (this.options.distortion && this.options.distortion.uniforms && this.options.distortion.uniforms.uTime) {
    ...
    const initApp = () => {
      ...
      const preset = hyperspeedPresets[activePreset] || hyperspeedPresets.two;
      const options = { ...preset, ...effectOptions };
      options.distortion = distortions[options.distortion];
      
      // Add uTime to distortion uniforms if not already present
      if (options.distortion && options.distortion.uniforms && !options.distortion.uniforms.uTime) {
        options.distortion.uniforms.uTime = { value: 0 };
      }
